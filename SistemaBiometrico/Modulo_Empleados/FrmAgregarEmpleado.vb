...
Public Class FrmAgregarEmpleado
    ...
    Private Sub FrmAgregarEmpleado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TxtPrompt.CharacterCasing = CharacterCasing.Upper
    ...
    Private Sub cargar_combo(cmb As ComboBox, codigo As String, mostrar As String, procedimiento As String)
        cmb.DataSource = Funciones.llenar_combo(procedimiento, "")
    ...
    Private Sub FrmAgregarEmpleado_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        pararCaptura()
    End Sub
    ...
    Function ImageToByte2(img As Image) As Byte()
    ...
    End Function
    Private Sub FrmAgregarEmpleado_Leave(sender As Object, e As EventArgs) Handles MyBase.Leave
        pararCaptura()
    End Sub
    ...
    Private Sub BTNAceptar_Click(sender As Object, e As EventArgs) Handles BTNAceptar.Click
        ...
        FnsEmpleado.agregar_empleado(oentidad)
